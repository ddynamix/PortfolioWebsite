                    ...
                    <section className="w-screen h-full">
                        <section className="min-h-screen flex items-center justify-center">
                            <div className="container mx-auto px-4">
                                ...
                                {/* Back Arrow */}
                                <p className="inline-block mb-2 text-black cursor-pointer hover:underline text-2xl"
                                ...
                                <div className="flex flex-col lg:flex-row gap-12 lg:gap-16">
                                    ...
                                    <div
                                        ...
                                        <div className="flex items-start justify-start mr-40 -mb-10">
                                            <CircularText
                                                text="PYTHON*C*JAVA*ASM*R*JS*TS*"
                                                onHover="slowDown"
                                                spinDuration={25}
                                                className="text-black text-center w-[200px] h-[200px]"
                                            />
                                        </div>
                                        <div className="flex items-end justify-end ml-70 -mb-15 -mt-15">
                                            <CircularText
                                                text={"PYTORCH*LLMS*DEVOPS*GITLAB*GITHUB*DOCKER*"}
                                                onHover="slowDown"
                                                spinDuration={15}
                                                direction="counterclockwise"
                                                className="text-black text-center w-[260px] h-[260px]"
                                            />
                                        </div>
                                        <div className="flex items-start justify-start mr-30">
                                            <CircularText
                                                text={"THREEJS*FRAMER*REACT*NEXTJS*HTML*CSS*TAILWIND*"}
                                                onHover="slowDown"
                                                spinDuration={20}
                                                className="text-black text-center w-[280px] h-[280px]"
                                            />
                                        </div>
                                    </div>
                                </div>
